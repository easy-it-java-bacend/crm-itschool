package kg.itschool.crm.views.groupsdetails;
...
@PageTitle("Groups Details")
@Route(value = "groups", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@PermitAll
@Tag("groups-details-view")
@JsModule("./views/groupsdetails/groups-details-view.ts")
public class GroupsDetailsView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public GroupsDetailsView() {
        addClassNames("groups-details-view", "flex", "flex-col", "h-full");
